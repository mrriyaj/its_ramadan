...
export default function Contact({ auth }) {
    return (
        <App auth={auth}>
            ...
            <div className="text-white md:max-w-7xl xl:p-0 mx-auto p-10 ">
                <h2 className="text-3xl pb-5 pt-10">
                    <b>PRIVACY POLICY</b>
                </h2>
                <p className="my-2">Effective date: 2024-03-03</p>
                <p className="my-2">
                    1. <b>Introduction</b>
                </p>
                <p className="mt-5 mb-2">
                    Welcome to <b> ItsRamadan</b>.
                </p>
                <p>
                    <b>ItsRamadan</b> (“us”, “we”, or “our”) operates{" "}
                    <b>itsramadan.com</b> (hereinafter referred to as{" "}
                    <b>“Service”</b>).
                </p>
                <p>
                    Our Privacy Policy governs your visit to{" "}
                    <b>itsramadan.com</b>, and explains how we collect,
                ...
                <p>
                    <b>SERVICE</b> means the itsramadan.com website operated by
                    ItsRamadan.
                </p>
                <p>
                ...
                <p>ItsRamadan uses the collected data for various purposes:</p>
                ...
                <p>
                    If you are located outside Sri Lanka and choose to provide
                    information to us, please note that we transfer the data,
                    including Personal Data, to Sri Lanka and process it there.
                </p>
                <p>
                ...
                <p>
                    ItsRamadan will take all the steps reasonably necessary to
                ...
                <p>
                    ...
                    please email us at <b>admin@itsramadan.com</b>.
                </p>
                <p>
                ...
                <p>
                    ...
                    emailing us at <b>admin@itsramadan.com</b>.
                </p>
                ...
                <p>
                    <b>
                        0.2. To delete your personal information. If you make
                ...
                <p>
                    <b>
                        ...
                        some circumstances, a transfer of personal information
                        to a third party, or within our family of companies,
                        without monetary consideration may be considered a
                        “sale” under California law. You are the only owner of
                        your Personal Data and can request disclosure or
                ...
                <p>
                    ...
                    contact us by email: <b>admin@itsramadan.com</b>.
                </p>
                <p>
                    This{" "}
                    <a href="https://policymaker.io/privacy-policy/">
                    ...
                    was created for <b>itsramadan.com</b> on 2024-03-03.
                </p>
            </div>
        </App>
    );
